                              ...
                              <div class="card">
                                  ...
                                  <div class="card-body card-block">
                                      <form id="shipadd" enctype="multipart/form-data" class="form-horizontal">
                                        {{csrf_field()}}
                                        <input type="hidden" name="id" value="{{$coupons[0]->id}}">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Coupon Code</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" value="{{$coupons[0]->code}}" id="text-input" name="code" placeholder="Code" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" id="text-input" value="{{$coupons[0]->count}}" name="count" placeholder="count" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="number" id="text-input" value="{{$coupons[0]->sold_value}}" name="sold_value" placeholder="sold_value" class="form-control">
