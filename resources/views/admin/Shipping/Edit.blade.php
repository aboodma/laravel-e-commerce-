                                      ...
                                      <form id="shipadd" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" value="{{$data[0]->name_ar}}" id="text-input" name="name_ar" placeholder="Company Name" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" value="{{$data[0]->name}}" name="name" placeholder="Company Name" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="name_gr" value="{{$data[0]->name_gr}}" placeholder="Company Name" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="price_dolar" placeholder="Price" value="{{$data[0]->price_dolar}}" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="price_euro" placeholder="Price" value="{{$data[0]->price_euro}}" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="price_kron" placeholder="Price" value="{{$data[0]->price_kron}}" class="form-control">
