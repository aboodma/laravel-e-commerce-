@extends('layouts.singleProduct.app')
			...
			<div id="content" class="col-md-12 col-sm-12">
              ...
              <div class="left-content-product col-lg-10 col-xs-12">
                  ...
                  @foreach($data['images'] as $image)
									<a data-index="{{$index++}}" class="img thumbnail " data-image="/{{$image->path}}" title="{{$data['productd'][0]->product_slug_en}}">
										<img src="/{{$image->path}}" title="{{$data['productd'][0]->product_slug_en}}" alt="{{$data['productd'][0]->product_slug_en}}">
									</a>
                  @endforeach
							...
							<div class="content-product-right col-sm-5 col-xs-12">
								<div class="title-product">
									<h1>{{$data['productd'][0]->product_name_en}}</h1>
								</div>
								<!-- Review ---->
                  ...
                  $price=$data['productd'][0]->price_dolar;
                    ...
                    break;
								...
								<div class="product-label form-group">
									...
									<div class="stock"><span>Status:</span> <span class="status-stock">Avaliable</span></div>
								</div>
								...
								<div class="product-box-desc">
									<div class="inner-box-desc">
										...
										<div class="model"><span> Product Description </span>
                			{!!$data['productd'][0]->product_info_en!!}
...
onclick="cart.addpro({{$data['productd'][0]->id}}, '1','/{{$data['images'][1]->path}}','{{$data['productd'][0]->product_name_en}}','{{$price}}');"
