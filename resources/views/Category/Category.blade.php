			...
			<div id="content" class="col-md-12 col-sm-12">
              ...
              <div class="col-sm-6">
                <div class="banners">
                  <div>
										<h1>Lorem ipsum</h1>
                    <p>{{$PageData['data'][0]->catinfo_en}}</p>
		...
		<div class="product-item-container">
			<div class="left-block">
				<div class="product-image-container  ">
					<img data-src="/{{$product->path}}" src="/{{$product->path}}"  alt="{{$product->product_slug_en}}" class="img_0 img-responsive" />
				</div>

				<!--full quick view block-->
				<a class="quickview "   href="/product/{{$product->product_slug_en}}"> Quick View</a>
