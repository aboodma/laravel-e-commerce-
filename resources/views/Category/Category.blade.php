                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="top-banner-wrapper">
                                            <a href="#"><img  src="../assets/images/mega-menu/2.jpg" class="img-fluid" alt=""/></a>
                                                        ...
                                                        <div class="col-xl-3 col-md-6 col-grid-box">
                                                            <div class="product-box">
                                                                <div class="img-wrapper">
                                                                    ...
                                                                    <div class="front">
                                                                        <a href="/product/{{$product->product_slug_ar}}"><img src="{{getenv('APP_URL')}}/{{$product->path}}" class="img-fluid" alt=""></a>
                                                                    </div>
                                                                    <div class="back">
                                                                        <a href="/product/{{$product->product_slug_ar}}"><img src="{{getenv('APP_URL')}}/{{$product->path}}" class="img-fluid" alt=""></a>
                                                                    </div>
