		...
		<div class="product-item-container">
			<div class="left-block">
				<div class="product-image-container  ">
					<img data-src="/{{$product->path}}" src="/{{$product->path}}"  alt="{{$product->product_slug_ar}}" class="img_0 img-responsive" />
				</div>

				<!--full quick view block-->
				<a class="quickview "   href="/product/{{$product->product_slug_ar}}">  مشاهدة المنتج</a>
          ...
          <?php   $session_currency=Session::get('session_currency'); ?>
            ...
            @if($session_currency=='kr')
				  ...
				  <div class="button-group">
					<!-- <button class="addToCart" type="button" data-toggle="tooltip" title="إضافة إلى السلة" onclick="cart.add('42', '1');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">إضافة إلى السلة</span></button> -->
				  </div>
			</div><!-- right block -->
