...
@section('content')
  ...
  <div class="main-container container">
		<ul class="breadcrumb">
			...
			<li><a href="#">Bestellinformationen</a></li>
		</ul>

		<div class="row">
			<!--Middle Part Start-->
			<div id="content" class="col-sm-9">
				<h2 class="title">Bestellinformationen</h2>

				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							<td colspan="2" class="text-left">Bestelldetails</td>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td style="width: 50%;" class="text-left"> <b>Auftragsnummer:</b> {{$PageData['data'][0]->order_id}}
								<br>
								<b>Datum hinzugefügt:</b> 20/06/2016</td>
							<td style="width: 50%;" class="text-left"> <b>Zahlungsmethode:</b>
				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<td style="width: 100%; vertical-align: top;" class="text-left">Lieferanschrift</td>
						</tr>
					</thead>
					<tbody>
						<tr>
