    ...
    <div class="header-bottom">
      ...
      <nav class="navbar-default">
        <div class=" container-megamenu  horizontal">
          ...
          <button type="button" onclick="Redirecter('/cart/show')" style="margin-top: 8px;top: -40px;right: -72px; padding-bottom: 3px;left: 0px;"    class="navbar-toggle" name="button">
            <img src="/image/theme/icons/icon_minicart.png" style="margin-right: -5px;margin-bottom: 0px;" />
          </button>
          <button type="button" onclick="Redirecter('/profile')" style="margin-top: 8px;top: -55px;right: 244px; padding-bottom: 3px;left: 0px;"  class="navbar-toggle" name="button">
          ...
          <div class="megamenu-wrapper">
            ...
            <div class="megamenu-pattern">
              <div class="container">
                <ul class="megamenu " dir="" data-transition="slide" data-animationtime="250">
